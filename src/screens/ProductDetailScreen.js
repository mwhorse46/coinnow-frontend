...
import { checkround2, close } from '@common';
import { SliderBox } from 'react-native-image-slider-box';
import { ScrollView, Button, Input } from 'native-base';
      ...
      return (
        <Dropdown
          ...
          onChange={changedItem => {
            setOptionSelect(changedItem.value, changedItem);
          }}
          renderLeftIcon={() => (
            <Icon
              style={styles.icon}
  ...
  const getDetails = useCallback(() => {
    ...
    getApi.getData('productDetail/' + id, []).then(response => {
      ...
      if (productData.data.image != null) {
        ...
        zoomImages.push({
          url: 'https://my.inventory.marketmajesty.net/uploads/assets/img/default.png',
        });
      }
